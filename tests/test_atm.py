...
def test_atm_successful_withdraw(
    ...
    # Начальный баланс 100 руб, списываем 11 руб
    ui = FakeUI(
        inputs=(
            "1333444455556666",
            "5678",
...
def test_atm_does_not_withdraw_incorrect_amount(
    ...
    # Начальный баланс 100 руб, списываем некорректную сумму
    ui = FakeUI(
        inputs=(
            "1333444455556666",
            "5678",
...
def test_atm_successful_deposit(
    ...
    # Начальный баланс 100 руб, пополняем на 115 руб
    ui = FakeUI(
...
def test_atm_does_not_deposit_incorrect_amount(
    ...
    # Начальный баланс 100 руб, пополняем на некорректную сумму
    ui = FakeUI(
        inputs=(
            "1333444455556666",
            "5678",
