...
def authenticate_user(cards: Cards) -> CardNumber:
    """
    Запрашивает у пользователя пин-код, пока он не будет введён.
...
def main(cards: Cards):
    ...
    try:
        user_card_number = authenticate_user(cards)
